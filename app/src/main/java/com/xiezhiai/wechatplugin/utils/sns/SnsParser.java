package com.xiezhiai.wechatplugin.utils.sns;

import com.xiezhiai.wechatplugin.utils.sns.bean.Comment;
import com.xiezhiai.wechatplugin.utils.sns.bean.Like;
...
public class SnsParser {
    ...
    public SnsParser(Class SnsDetail, Class SnsDetailParser, Class SnsObject) {
    ...
    public Object parseSnsDetailFromBin(byte[] bin) throws Throwable {
        ...
        Method fromBinMethod = SnsDetail.getMethod(SnsParam.SNS_DETAIL_FROM_BIN_METHOD, byte[].class);
        fromBinMethod.invoke(snsDetail, bin);
        return snsDetail;
    }

    public SnsInfo parseSnsDetail(Object snsDetail) throws Throwable {
        Method snsDetailParserMethod = SnsDetailParser.getMethod(SnsParam.SNS_XML_GENERATOR_METHOD, SnsDetail);
    ...
    public Object parseSnsObjectFromBin(byte[] bin) throws Throwable {
        ...
        Method fromBinMethod = SnsObject.getMethod(SnsParam.SNS_OBJECT_FROM_BIN_METHOD, byte[].class);
    ...
    static public void parseSnsObject(Object aqiObject, SnsInfo matchSns) throws Throwable {
        ...
        field = aqiObject.getClass().getField(SnsParam.PROTOCAL_SNS_OBJECT_USERID_FIELD);
        userId = field.get(aqiObject);

        field = aqiObject.getClass().getField(SnsParam.PROTOCAL_SNS_OBJECT_NICKNAME_FIELD);
        nickname = field.get(aqiObject);

        field = aqiObject.getClass().getField(SnsParam.PROTOCAL_SNS_OBJECT_TIMESTAMP_FIELD);
        ...
        field = aqiObject.getClass().getField(SnsParam.PROTOCAL_SNS_OBJECT_COMMENTS_FIELD);
        ...
        field = aqiObject.getClass().getField(SnsParam.PROTOCAL_SNS_OBJECT_LIKES_FIELD);
    ...
    static public void parseSnsObjectExt(Object apzObject, boolean isComment, SnsInfo matchSns) throws Throwable {
        if (isComment) {
            Field field = apzObject.getClass().getField(SnsParam.SNS_OBJECT_EXT_AUTHOR_NAME_FIELD);
            Object authorName = field.get(apzObject);

            field = apzObject.getClass().getField(SnsParam.SNS_OBJECT_EXT_REPLY_TO_FIELD);
            Object replyToUserId = field.get(apzObject);

            field = apzObject.getClass().getField(SnsParam.SNS_OBJECT_EXT_COMMENT_FIELD);
            Object commentContent = field.get(apzObject);

            field = apzObject.getClass().getField(SnsParam.SNS_OBJECT_EXT_AUTHOR_ID_FIELD);
